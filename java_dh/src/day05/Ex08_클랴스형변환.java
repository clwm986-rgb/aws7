...
public class Ex08_클랴스형변환 {
	...
	public static void main(String[] args) {
		...
		//업캐스팅, 자식객체 -> 부모 객처로 변환
		Rect 사각형2 =new Rect(10, 10, 20, 20);
		Shape 도형2 = 사각형2;
		도형2.draw();
		//Shape에는 resize가 없어서 실행 안됨
		// 실제 도형2 객체 안에는 resize 기능이 잇긴함.
		// 하지만 도형2는 Shape클래스의 객체이고, Shape에는 resize기능이 없어서 안됨
		
		//다운캐스팅, 부모객체 -> 자식 객체로 변환, 조건부로 가능
		//안되는 경우
		Shape 도형3 = new Shape();
//		Rect 사각형3 = (Rect)도형3;
//		사각형3.draw();
		
		//되는 경우 : 업캐스팅된 객체를 다시 다운 캐스팅 하는 경우
