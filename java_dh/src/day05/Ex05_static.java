...
public class Ex05_static {
	...
	public static void main(String[] args) {
		/* static p.192
	       ...
	       */
		클래스A.name = "홍길동";
		//클래스A.addres = "서울"; //static이 안붙음 => 에러발생
		...
		System.out.println("객체A의 주소를 경긷로로 변경(static 변수 아님)");
		객체A.address = "경기도";
...
class 클래스A{
	...
	public void print() {// static이 없는 메서드
		
		System.out.println("-------------------------------");//static이 잇는 변수 사용가능
		System.out.println("이름 : " + name);
		System.out.println("주소 : " + address);//static이 없는 변수 사용가능
		System.out.println("이름 : " + name);
		System.out.println("-------------------------------");
		
	}
	
	public void print2() {// static이 잇는 메서드
		
		System.out.println("-------------------------------"); //static이 잇는 변수 사용가능
		System.out.println("이름 : " + name);
		System.out.println("주소 : " + address); //static이 없는 변수 사용 불가능
		System.out.println("이름 : " + name);
		System.out.println("-------------------------------");
